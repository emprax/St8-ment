...
{
    public class StateTransitionerApplier<TState, TContext> : IStateTransitionerApplier<TState, TContext>
        ...
        where TContext : class, IStateContext<TContext>
    {
        ...
        public StateTransitionerApplier(IStateTransitionerProvider<TState, TContext> provider, TState state)
        {
