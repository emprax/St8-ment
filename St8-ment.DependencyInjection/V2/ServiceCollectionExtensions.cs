...
namespace St8_ment.DependencyInjection.V2
{
    ...
    {
        public static IServiceCollection AddStateMachineV2<TContext>(this IServiceCollection services, Action<IStateMachineBuilder<TContext>> builder) where TContext : IStateContext<TContext>
        {
